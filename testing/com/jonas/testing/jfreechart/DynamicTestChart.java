 ...
 * <p>
 * IMPORTANT NOTE: THIS DEMO IS DOCUMENTED IN THE JFREECHART DEVELOPER GUIDE. DO NOT MAKE CHANGES WITHOUT UPDATING THE GUIDE ALSO!!
 */
public class DynamicTestChart extends JPanel {
    ...
    */
   public DynamicTestChart(int maxAge) {
      ...
      chartPanel.setBorder(BorderFactory.createCompoundBorder(BorderFactory.createEmptyBorder(4, 4, 4, 4), BorderFactory
   ...
   public static void main(String[] args) {
      ...
      DynamicTestChart panel = new DynamicTestChart(30000);
