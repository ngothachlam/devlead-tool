...
public class JiraTableModel extends MyTableModel {
   ...
   private static final Column[] columns = { Column.Jira, Column.Description, Column.BoardStatus, Column.J_Type, Column.Planned_Sprint,
         Column.Resolved_Sprint, Column.Closed_Sprint, Column.J_FixVersion, Column.J_Status, Column.J_Resolution, Column.J_BuildNo,
