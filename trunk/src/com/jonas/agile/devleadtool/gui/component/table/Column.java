...
public enum Column {
   ...
   DevEst(String.class, "", IsEditableColumn.Yes, IsJiraColumn.No, ToLoadColumn.Yes, true, CacheMode.noCache),
   DevRem(String.class, "", IsEditableColumn.Yes, IsJiraColumn.No, ToLoadColumn.Yes, true, CacheMode.noCache),
   QAEst(String.class, "", IsEditableColumn.Yes, IsJiraColumn.No, ToLoadColumn.Yes, true, CacheMode.noCache),
   DevAct(String.class, "", IsEditableColumn.Yes, IsJiraColumn.No, ToLoadColumn.Yes, true, CacheMode.noCache),
