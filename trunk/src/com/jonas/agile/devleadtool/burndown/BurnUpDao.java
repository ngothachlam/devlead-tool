...
public class BurnUpDao {
   private static final String SHEETNAME = "BurnUpData";
   private Logger log = MyLogger.getLogger(BurnUpDao.class);
   ...
   public void load(SprintCache sprintCache, File xlsFile) throws IOException {
      ...
      try {
         ...
         HSSFSheet sheet = PlannerDAOExcelImpl.getSheet(SHEETNAME, wb, false);
   ...
   public void save(File xlsFile, SprintCache sprintCache) throws IOException {
      ...
      try {
         ...
         if (fileIn != null)
            fileIn.close();
         HSSFSheet sheet = PlannerDAOExcelImpl.getSheet(SHEETNAME, wb, true);
