...
public class JiraHttpClient extends HttpClient {
	...
	public List<JiraIssue> getJiras(JiraVersion fixVersion) throws HttpException, IOException, JDOMException {
		log.debug("getting Jiras");
		String url = baseUrl + "/secure/IssueNavigator.jspa?view=rss&&fixfor=" + fixVersion.getId() + "&pid="
				+ fixVersion.getProject().getId() + "&sorter/field=issuekey&sorter/order=DESC&reset=true&decorator=none";
