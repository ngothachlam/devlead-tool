...
public class JiraStatChart extends ApplicationFrame {
   ...
   private String[] wrapperFixVersions = {
         "Trio - DNA v1 - drop 1",
         "Trio - DNA v1 - drop 2",
         "Trio - DNA v1 - drop 3",
         "Trio - Wrapper v1 - drop1",
         "Trio - Wrapper v1 - drop2",
         "Trio - Wrapper v1 - drop3",
         "Trio - LLU v17 - drop 1",
         "Trio - LLU v17 - drop 2",
         "Trio - LLU v17 - drop 3",
         "Cogito - v 1"
...
//         JiraCriteriaBuilder criteria = getCriteria(JiraProject.LLU, wrapperFixVersions);
   ...
   private JiraCriteriaBuilder getCriteria(JiraProject project, String... fixVersions) throws RemotePermissionException, RemoteAuthenticationException, RemoteException, java.rmi.RemoteException {
      ...
      for (String fixVersion : fixVersions) {
         criteria = criteriabuilder.fixVersion(project.getFixVersion(fixVersion));
      }
      return criteria;
   }
   ...
   public JPanel createChartPanel(PointsInTimeFacadeAbstract<JiraStatus, ? extends RegularTimePeriod> dataSetAggregator, boolean aggregate) {
      GroupingDTO<JiraStatus>[] groupings = new GroupingDTO[] {
            ...
            new GroupingDTO<JiraStatus>(JiraStatus.Closable, SwingUtil.cellGreen)
            };
