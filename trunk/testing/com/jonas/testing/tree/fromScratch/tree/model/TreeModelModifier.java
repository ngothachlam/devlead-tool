...
public class TreeModelModifier extends DefaultTreeModel {

   private Logger log = MyLogger.getLogger(TreeModelModifier.class);
   ...
   public TreeModelModifier(String rootName) {
