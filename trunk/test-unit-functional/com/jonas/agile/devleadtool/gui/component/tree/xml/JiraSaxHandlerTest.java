...
public class JiraSaxHandlerTest extends TestCase {
   ...
   private void assertJiraDTO(String key, String id, String resolution, String sprint, String status, String summary, boolean syncable,
         int originalEstimate, String project, String owner, String environment, String... fixVersions) {
      ...
      assertEquals(owner, jiraParsed.getOwner());
      assertEquals(environment, jiraParsed.getEnvironment());
   }
   ...
   public void testShouldParseOneJiraOk() throws FileNotFoundException, IOException, SAXException {
      ...
      assertJiraDTO("LLU-4474", "44057", "Unresolved", "13-1", "Open",
            "[Merge for LLU-4455] Bulk Tie Pair Fix - unable to Upload a csv file to fix FAULTY Tie Pairs", false, 0, "Flexi Cease", "Technology", "QA",
            "LLU 13");
   }
   ...
   public void testShouldParseManyJirasOk() throws FileNotFoundException, IOException, SAXException {
      ...
      assertJiraDTO("LLU-4211", "41698", "Unresolved", "12.4", "Open", "Fens \"Unhandled Exception Occurred\" failure", false, 0, "", "", "",
            "LLU 12");
      assertJiraDTO("LLU-4104", "40487", "Unresolved", "12.4", "Open", "Merge -Deadlock Servlet processes records which are in an end state",
            false, 0, "", "", "", "Pam&apos;s Backlog");
      assertJiraDTO("LLU-4190", "41524", "Fixed", "12-4", "Closed", "Provide E2E fitnesse test for BBMS Northbound Status updates", false, 0,
            "", "", "");
      assertJiraDTO("LLU-4148", "40895", "DEV Complete", "12-4", "Resolved",
            "[FC-ReserveLogic] Process MLC state is jumpered to a line that is not available - SM", false, 28800, "", "", "", "LLU 12");
      assertJiraDTO("LLU-4474", "44057", "Unresolved", "13-1", "Open",
            "[Merge for LLU-4455] Bulk Tie Pair Fix - unable to Upload a csv file to fix FAULTY Tie Pairs", false, 0, "Flexi Cease", "", "",
            "LLU 13");
   }
