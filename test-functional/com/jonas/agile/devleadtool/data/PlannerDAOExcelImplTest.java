...
public class PlannerDAOExcelImplTest extends TestCase {
	...
	public void testSouldSaveAndLoadBoardCorrectly() throws IOException {
		...
		assertRowInModel(0, model_loaded,
				new Object[] { "", Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, "" });
		...
		assertRowInModel(0, model_loaded,
				new Object[] { "", Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, "" });
		assertRowInModel(1, model_loaded, new Object[] { "123", Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, Boolean.FALSE, Boolean.FALSE,
				"LLU-123" });
		assertRowInModel(2, model_loaded, new Object[] { "1234", Boolean.TRUE, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, Boolean.TRUE,
				"LLU-1234" });
	}
	...
	public void testSouldSaveAndLoadJiraCorrectly() throws IOException {
		...
		assertHeaderInModel(model_loaded, new Object[] { "Jira", "FixVersion", "Status", "Resolution" });
		assertEquals(0, model_loaded.getRowCount());

		// Modify,
		model_loaded.addRow(new Object[] { "123", JiraVersion.Version10, "1", "2" });
		model_loaded.addRow(new Object[] { "1234", JiraVersion.Version11, "3", "4" });
		...
		assertEquals(4, model_loaded.getColumnCount());
		assertHeaderInModel(model_loaded, new Object[] { "Jira", "FixVersion", "Status", "Resolution" });
		assertRowInModel(0, model_loaded, new Object[] { "123", "Version 10", "1", "2" });
		assertRowInModel(1, model_loaded, new Object[] { "1234", "Version 11", "3", "4" });
	}
	...
	private void assertRowInModel(int row, TableModel model, Object[] expected) {
		for (int j = 0; j < expected.length; j++) {
			assertEquals(expected[j], model.getValueAt(row, j));
		}
	}
}
